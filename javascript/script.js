...
function updateTimer() {
  const targetDate = new Date("february 15, 2026 21:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543834359753'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543834968016'; // Número para el primer botón
  const recipientNumber2 = '543834359753'; // Número para el segundo botón
